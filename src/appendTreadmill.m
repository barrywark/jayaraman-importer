function epoch = appendTreadmill(epoch,...
    ...
    r = epoch.insertResponse(camera1,...
    ...
    r = epoch.insertResponse(camera2,...
            struct2map(device_params),...
            NumericData([0, 0], shape),...
            units,...
            dimensionLabels,...
    ...
    r.addProperty('__ovation_url', treadmillFile);
    r.addProperty('__ovation_retrieval_funcion', dataRetrievalFunction);
    r.addProperty('__ovation_retrieval_parameter1', treadmillFile);
end
